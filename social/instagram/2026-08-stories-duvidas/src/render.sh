#!/usr/bin/env bash
# Gera os PNGs 1080x1920 (9:16) dos stories a partir de slides.html.
#
...
names=(01-capa 02-doi 03-roupa 04-sessoes 05-gravidez 06-menstruacao 07-hernia 08-chamada)

# A janela é pedida mais alta que o story porque o headless reserva alguns
...
if im.size != (1080, 1920):
    im.crop((0, 0, 1080, 1920)).convert("RGB").save(p, optimize=True)
PY
  echo "→ ${names[$((i-1))]}.png"
done
